...
const BoilerplateLogo: React.FC = () => {
	return (
		<Typography
			variant="subtitle1"
			sx={{ color: (theme) => theme.palette.sysText?.tertiary, display: 'flex', alignItems: 'center', gap: '8px' }}>
			{'{ '}
			<Typography sx={{ color: (theme) => theme.palette.primary.contrastText }} variant="inherit">
				Boilerplate
			</Typography>{' '}
			{'}'}
		</Typography>
