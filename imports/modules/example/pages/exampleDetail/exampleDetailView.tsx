				...
				<Body>
					<FormColumn>
						...
						<SysUploadFile
							...
							moduleName="example"
							validTypes={['image']}
							btnTextDesc="Selecione ou arraste imagens"
						/>
						<SysUploadFile
							name="audios"
							moduleName="example"
							...
							btnTextDesc="Selecione um áudio ou grave pelo microfone"
						/>
						<SysUploadFile name="files" moduleName="example" btnTextDesc="Anexos disponíveis para download" />
